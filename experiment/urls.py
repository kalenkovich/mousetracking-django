...
urlpatterns = [
    ...
    re_path(r'(?:test/)?goodbye/', views.goodbye, name='dedicated_goodbye'),
    path('headphone_check_json', views.headphone_check_json, name='headphone_check_json'),
    path('save_headphone_check_results', views.save_headphone_check_results, name='save_headphone_check_results'),
]
